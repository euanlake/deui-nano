...
#define EXAMPLE_LVGL_TICK_PERIOD_MS    5                          //Timer time
#define EXAMPLE_LVGL_TASK_MAX_DELAY_MS 100                        //LVGL Indicates the maximum time for a task to run
...
#define EXAMPLE_LVGL_TASK_PRIORITY     3                          //LVGL Running task priority
